...
@font-face {
  ...
  src: url("https://cdnjs.cloudflare.com/ajax/libs/materialize/0.95.2/font/material-design-icons/Material-Design-Icons.eot?-g7cqhn");
  src: url("https://cdnjs.cloudflare.com/ajax/libs/materialize/0.95.2/font/material-design-icons/Material-Design-Icons.eot?#iefix-g7cqhn") format("embedded-opentype"), url("https://cdnjs.cloudflare.com/ajax/libs/materialize/0.95.2/font/material-design-icons/Material-Design-Icons.woff?-g7cqhn") format("woff"), url("https://cdnjs.cloudflare.com/ajax/libs/materialize/0.95.2/font/material-design-icons/Material-Design-Icons.ttf?-g7cqhn") format("truetype"), url("https://cdnjs.cloudflare.com/ajax/libs/materialize/0.95.2/font/material-design-icons/Material-Design-Icons.svg?-g7cqhn#Material-Design-Icons") format("svg");
  font-weight: normal;
  font-style: normal; }
...
.input-field {
  ...
  .input-field input[type=text].valid, .input-field input[type=password].valid, .input-field input[type=email].valid, .input-field input[type=url].valid, .input-field input[type=date].valid, .input-field input[type=tel].valid, .input-field input[type=number].valid, .input-field input[type=search].valid, .input-field textarea.materialize-textarea.valid {
    ...
    -webkit-box-shadow: 0 1px 0 0 #FFDF00;
    -moz-box-shadow: 0 1px 0 0 #FFDF00;
    box-shadow: 0 1px 0 0 #FFDF00; }
